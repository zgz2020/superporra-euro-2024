...
// export function* getUpdatedTeamsSaga() {
//     while (true) {
//         const { predictionType, stage } = yield take(mutations.GOALS_UPDATED)
        
//         // Gets newPrediction/predictions/results state from store
//         const prediction, updatedTeams = {}
//         const euroWinnerTeam = ''
//         const topScorer, leastConceded = []
        

//         switch(predictionType) {
//             case 'new': 
//                 prediction = yield select(selectors.getNewPrediction)
//             case 'existent': 
//                 prediction = yield select(selectors.getPredictions)
//             case 'results': 
//                 prediction = yield select(selectors.getResults)
//         }
        
//         switch(stage) {
//             case 'leagueMatches':
//                 updatedTeams = getR16Teams(prediction)
//             case 'r16Matches':
//                 updatedTeams = getQuarterFinalTeams(prediction)
//             case 'quarterFinalMatches':
//                 updatedTeams = getSemiFinalTeams(prediction)
//             case 'semiFinalMatches':
//                 updatedTeams = getFinalTeams(prediction)
//             case 'finalMatches':
//                 euroWinnerTeam = getEuroWinner(prediction)
//                 topScorer = getTopScorer(prediction)
//                 leastConceded = getLeastConceded(prediction)
//         }
        
//         // Updates newPrediction/predictions/results state with 'stage teams
//         // And then triggers action to update next euro stage teams if needed
//         if (predictionType === 'new') {
//             if (stage === finalMatches) {
//                 // !!!!!!!!!!!!!!!!!!!! TO BE DONE
//             } else {
//                 yield put(mutations.setUpdatedTeamsNewPrediction(stage, updatedTeams))
//                 yield put(mutations.updatedTeamsNewPrediction(stage))
//             }
//         }
...
//             } else {
//                 yield put(mutations.setUpdatedTeamsExistentPrediction(stage, updatedTeams))
//                 yield put(mutations.updatedTeamsExistentPrediction(stage))
//             }
//         }
...
//             } else {
//                 yield put(mutations.setUpdatedTeamsResults(stage, updatedTeams))
//                 yield put(mutations.updatedTeamsResults(stage))
//             }
//         }
